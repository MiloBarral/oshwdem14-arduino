...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \begin{tabular}{l l}
    \textbf{$=$} &  assignment \\
    \textbf{$+,$ \hspace{2pt} $ - $} & addition, substraction \\
    \textbf{$*,$ \hspace{2pt} $ /$} &  multiplication, division \\
    \textbf{$\%$} & modulo \\
    \textbf{$==$} & equal to \\
    \textbf{$!=$} & not equal to \\
    \textbf{$<$} & less than \\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\headerbox{Punteros}{name=pointers,column=0,below=general_operators}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \begin{tabular}{l l}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\headerbox{Pineado ATmega328}{name=pinout,column=2,below=random,bottomaligned=compound}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \begin{center}
    \includegraphics[height=0.1655\textheight]{./images/ArduinoImages6.pdf}
  \end{center}
}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \begin{center}
    \includegraphics[width=0.95\textwidth]{./images/ArduinoUno_R3_Front.jpg}
  \end{center}
}
